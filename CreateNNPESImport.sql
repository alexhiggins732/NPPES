-- Script to create table definitions specified in NPPES Data Dissemination_Public File- Readme.pdf 
Create Table [NPIRAW] (
[NPI] int not null,
...
[Provider Enumeration Date] SmallDateTime,
[Last Update Date] SmallDateTime,
[NPI Deactivation Reason Code] varchar(2),
[NPI Deactivation Date] SmallDateTime,
[NPI Reactivation Date] SmallDateTime,
